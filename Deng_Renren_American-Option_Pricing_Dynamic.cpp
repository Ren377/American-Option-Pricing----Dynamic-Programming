// Renren Deng
// Using the reference from the class codes
...
int main (int argc, char* argv[])
{
    ...
    cout << "--------------------------------------" << endl;
    cout << "Price of an American Call Option using dynamic programming = " << american_call_option_dyn_prog() << endl;
    cout << "Price of an American Put Option using dynamic programming = " << american_put_option_dyn_prog() << endl;
